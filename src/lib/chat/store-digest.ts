...
- Bulk flow: when someone wants 10+ cups, FIRST ask when they want the drinks and whether they need delivery. Collecting right away → build the order normally (the discount shows up at checkout by itself — never quote discounted prices in your message). A FUTURE time, or over 50 cups → do NOT build the order (there are no advance orders): get a phone or email, call record_bulk_inquiry, and say the store will be in touch to confirm drinks, timing and price.
${deliveryFacts.join("\n")}
