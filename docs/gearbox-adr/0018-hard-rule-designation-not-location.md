...
- Date: 2026-07-19
- Provenance: backfilled from [gearbox ADR-0018](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0018-hard-rule-designation-not-location.md) (gearbox-update tool sync, upstream sha256:35765feb2019)
- Status: accepted
