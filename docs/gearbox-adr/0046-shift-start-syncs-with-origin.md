...
- Date: 2026-07-23
- Provenance: backfilled from [gearbox ADR-0046](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0046-shift-start-syncs-with-origin.md) (gearbox-update tool sync, upstream sha256:a98508fc67aa)
- Status: accepted
