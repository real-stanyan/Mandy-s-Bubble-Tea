...
- Date: 2026-07-22
- Provenance: backfilled from [gearbox ADR-0034](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0034-maintainer-anchors-github-username.md) (gearbox-update tool sync, upstream sha256:d40854652b43)
- Status: accepted
