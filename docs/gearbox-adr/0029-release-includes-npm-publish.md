...
- Date: 2026-07-20
- Provenance: backfilled from [gearbox ADR-0029](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0029-release-includes-npm-publish.md) (gearbox-update tool sync, upstream sha256:a41a001bc696)
- Status: accepted
