...
- Date: 2026-07-19
- Provenance: backfilled from [gearbox ADR-0019](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0019-definition-exemption-for-context-glossary.md) (gearbox-update tool sync, upstream sha256:efd329b2f8ee)
- Status: accepted
