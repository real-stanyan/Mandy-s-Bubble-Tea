...
- Date: 2026-07-22
- Provenance: backfilled from [gearbox ADR-0037](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0037-protocol-files-never-gitignored.md) (gearbox-update tool sync, upstream sha256:7ac3794993d9)
- Status: accepted
