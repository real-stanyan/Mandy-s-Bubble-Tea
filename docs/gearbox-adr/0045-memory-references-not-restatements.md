...
- Date: 2026-07-23
- Provenance: backfilled from [gearbox ADR-0045](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0045-memory-references-not-restatements.md) (gearbox-update tool sync, upstream sha256:06fc7ad5f0ff)
- Status: accepted
