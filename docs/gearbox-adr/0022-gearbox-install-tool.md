...
- Date: 2026-07-19
- Provenance: backfilled from [gearbox ADR-0022](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0022-gearbox-install-tool.md) (gearbox-update tool sync, upstream sha256:810ef2ba392c)
- Status: accepted
