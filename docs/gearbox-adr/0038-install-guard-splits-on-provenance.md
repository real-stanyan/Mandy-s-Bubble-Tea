...
- Date: 2026-07-22
- Provenance: backfilled from [gearbox ADR-0038](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0038-install-guard-splits-on-provenance.md) (gearbox-update tool sync, upstream sha256:6739ddd511e6)
