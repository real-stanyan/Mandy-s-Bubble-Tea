...
- Date: 2026-07-22
- Provenance: backfilled from [gearbox ADR-0032](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0032-english-as-protocol-language.md) (gearbox-update tool sync, upstream sha256:c7b7fa56839f)
- Status: accepted
