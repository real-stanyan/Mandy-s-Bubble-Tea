...
- Date: 2026-07-23
- Provenance: backfilled from [gearbox ADR-0043](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0043-prune-cleans-agent-worktrees.md) (gearbox-update tool sync, upstream sha256:5daf9396b70e)
- Status: accepted
